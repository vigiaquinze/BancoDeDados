...
<body>
    ...
    <div class="content col-6 listar justify-content-center">
                ...
                <?php foreach ($contacts as $contact) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="excluirCarro.php?id_carro=<?= $contact['id_carro'] ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <div class="pagination">
            <?php if ($page > 1) : ?>
                <a href="listarCarros.php?page=<?= $page - 1 ?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
            <?php endif; ?>
            <?php if ($page * $records_per_page < $num_contacts) : ?>
                <a href="listarCarros.php?page=<?= $page + 1 ?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
            <?php endif; ?>
        </div>
    </div>
    <?= template_footer() ?>
