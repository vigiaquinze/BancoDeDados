    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="listaCarros.php">Carros</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="indexAdmin.php">Área do Admin</a>
                </li>
            </ul>
        </div>
    </nav>
...
function template_footer()
{
    ...
    <footer class="bg-dark text-white text-center py-3 mt-4">
        <p>&copy; 2024 MovelCar. Todos os direitos reservados.</p>
    </footer>
    EOT;
}